...
Dokumen ini menjelaskan semua modifikasi yang dilakukan pada fork ini (`picoclaw-32bit-main`) dibandingkan dengan proyek upstream [PicoClaw](https://github.com/sipeed/picoclaw).
