...
Questo documento descrive tutte le modifiche apportate a questo fork (`picoclaw-32bit-main`) rispetto al progetto upstream [PicoClaw](https://github.com/sipeed/picoclaw).
