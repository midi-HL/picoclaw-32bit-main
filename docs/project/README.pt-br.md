...
Este documento descreve todas as modificações feitas neste fork (`picoclaw-32bit-main`) em comparação com o projeto upstream [PicoClaw](https://github.com/sipeed/picoclaw).
